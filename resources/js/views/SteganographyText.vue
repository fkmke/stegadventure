...
<template>
    <TextTemplate>
        ...
        <p>
            ...
            When the plaintext is encrypted with a encryption key, it should be unreadable for a possible interceptor of
        ...
        <p>
            A famous basic cryptography algorithm is the Caesar Cipher, in which each alphabet letter is shifted by. For
            example, you can replace all 'A' by 'B'. 'BAG' will then become 'CBH'. The encryption key is the number of
        ...
        <p>
            ...
            known or cannot be guessed, the message's content is safe.
        </p>
        ...
        <p>
            One of the first records of steganography is from 499BC. The ruler of Miletus shaved the head of one of his
        ...
        <p>
            In the digital world, messages can be hidden within digital files, like audio fragments, PDF files, images,
            and many more digital media. These files are represented by bits, and by adjusting or adding bits, secret
        ...
        <p>
            ...
            secret messages with instructions for the attack.
        </p>
        <p>
            ...
            contained and if steganography was really used. People can just post images anonymously and others can
        ...
        <p>
            When flip from each colour value the least significant bit, thus we get <span
                class="color-2">1111111<b>0</b> 0110010<b>0</b> 1100001<b>1</b></span>, the change
            in colour is present, but barely visible with the human eye in an image with lots of noise.
        </p>
        <p>
            Since changing this last bit does not influence the picture very much we can use those bits to hide a
